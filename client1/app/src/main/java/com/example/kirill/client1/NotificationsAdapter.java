...
public class NotificationsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    //data "input"
    public NotificationsAdapter(Context context, List<Notification> eventList) {
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder viewHolder, int i) {
        ((Item)viewHolder).event_name.setText(eventList.get(i).title);
        ((Item)viewHolder).event_desc.setText(eventList.get(i).description);
        ((Item)viewHolder).author_name.setText(eventList.get(i).author);
        ((Item)viewHolder).author_name.setTextColor(Color.parseColor(getColor(eventList.get(i).author)));
